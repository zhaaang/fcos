...
if __name__ == "__main__":
    ...
    eval_dataset = VOCDataset(root_dir='/home/Disk1/zhangqiang/objectdetection/data/VOCdevkit/VOC2007', resize_size=[800, 1333],
                              split='test1', use_difficult=False, is_train=False, augment=None)
    ...
    for i in range(len(pred_boxes)):
        print('picture {}'.format(i+1))
        print('    pred_classes is: {}'.format(pred_classes[i]))
        print('    pred_classes is: {}'.format(pred_classes[i]))
        print('    pred_boxes is: {}'.format(pred_boxes[i]))
